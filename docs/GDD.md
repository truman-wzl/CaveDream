...
- **商店**：花 **50 铸梦币**一次性购买 **《世界准则法典》**（`GameSave.codexOwned` 权限标记，非背包物品）。
...
| P7 | 动态视差背景 | 🟡首版已实现（视差云/星/日月/昼夜渐变）；各高度带·生物群系专属背景待做（**含天空岛高空背景偏暗待修**） | M3 |
